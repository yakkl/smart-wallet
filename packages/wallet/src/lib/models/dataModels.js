...
exports.yakklStoredObjects = exports.sampleWatch = exports.yakklWatchList = exports.yakklBlockedList = exports.yakklConnectedDomains = exports.yakklChats = exports.yakklContacts = exports.yakklPrimaryAccounts = exports.yakklAccounts = exports.yakklNFT = exports.yakklContact = exports.yakklConnectedDomain = exports.yakklAccount = exports.yakklPrimaryAccount = exports.yakklCurrentlySelected = exports.yakklChat = exports.profile = exports.yakklRegisteredData = exports.yakklBlocked = exports.yakklSecurity = exports.yakklWatch = exports.yakklSettings = exports.yakklPreferences = exports.yakklWalletProviders = exports.yakklWalletBlockchains = exports.prerender = void 0;
...
var datetime_1 = require("$lib/common/datetime");
...
exports.yakklPreferences = {
    ...
    wallet: {
        ...
        extensionHeight: constants_1.DEFAULT_EXT_HEIGHT,
        popupHeight: constants_1.DEFAULT_POPUP_HEIGHT,
        popupWidth: constants_1.DEFAULT_POPUP_WIDTH,
        enableContextMenu: false,
        enableResize: false,
        splashDelay: constants_1.SPLASH_DELAY,
        alertDelay: constants_1.ALERT_DELAY,
        splashImages: constants_1.NUM_OF_SPLASH_IMAGES,
    ...
    version: constants_1.VERSION, // Travels with the data for upgrades
    createDate: (0, datetime_1.dateString)(),
    updateDate: (0, datetime_1.dateString)(),
};
// Settings - Mostly items that are automatically updated by the system
exports.yakklSettings = {
    id: '', // Profile id
    version: constants_1.VERSION, // Uses semversion format but puts 'default' as a placeholder
    previousVersion: '',
    registeredType: types_1.RegistrationType.STANDARD, // This data comes from yakklRegisteredData.type
    legal: {
        termsAgreed: false,
        privacyViewed: false,
    ...
    upgradeDate: '',
    lastAccessDate: (0, datetime_1.dateString)(),
    createDate: (0, datetime_1.dateString)(),
    updateDate: (0, datetime_1.dateString)(),
};
exports.yakklWatch = {
...
exports.yakklBlocked = {
    domain: '',
};
exports.yakklRegisteredData = {
    key: '',
    type: types_1.RegistrationType.STANDARD,
...
exports.profile = {
    ...
    preferences: exports.yakklPreferences,
    data: {},
    version: constants_1.VERSION, // Travels with the data for upgrades
    createDate: (0, datetime_1.dateString)(),
    updateDate: (0, datetime_1.dateString)(),
...
exports.yakklCurrentlySelected = {
    id: '', // Profile id
    shortcuts: {
        ...
        accountType: types_1.AccountTypeCategory.PRIMARY, // primary, imported, sub
        accountName: constants_1.YAKKL_ZERO_ACCOUNT_NAME, // shortcut for account.name
        smartContract: false,
        address: constants_1.YAKKL_ZERO_ADDRESS, // So we don't have to hit yakklAccount every time
        ...
        networks: [
            {
                ...
                chainId: 1,
                symbol: 'ETH',
                type: types_1.NetworkType.MAINNET,
            ...
            },
            {
                ...
                chainId: 11155111,
                symbol: 'ETH',
                type: types_1.NetworkType.TESTNET,
    ...
    data: {},
    version: constants_1.VERSION, // travels with the data and mainly used for upgrades
    createDate: (0, datetime_1.dateString)(),
    updateDate: (0, datetime_1.dateString)(),
};
...
exports.yakklPrimaryAccount = {
    id: '', // Profile id
    name: constants_1.YAKKL_ZERO_ACCOUNT_NAME, // account name, address, and keys are here for convenience - they are also in the yakklAccount record 
    address: constants_1.YAKKL_ZERO_ADDRESS,
    value: 0n,
...
exports.yakklAccount = {
    ...
    address: constants_1.YAKKL_ZERO_ADDRESS, // Must be unique
    alias: '',
    accountType: types_1.AccountTypeCategory.PRIMARY, //'imported' | 'sub' | 'primary',  // May need to add 'NFT' or 'RWA' or something else for different types of accounts - ??
    name: constants_1.YAKKL_ZERO_ACCOUNT_NAME,
    description: '', // Can use this to describe an account associated with an NFT or RWA (Real World Asset) or class
    primaryAccount: exports.yakklPrimaryAccount, // If the account is a primary account then this is empty
    data: {}, // Encrypted
...
exports.yakklPrimaryAccount.account = exports.yakklAccount;
// Tracks the domain/dApp connected to a given address
exports.yakklConnectedDomain = {
    id: '',
...
// Lists...
exports.yakklAccounts = [exports.yakklAccount];
exports.yakklPrimaryAccounts = [exports.yakklPrimaryAccount];
exports.yakklContacts = [exports.yakklContact];
exports.yakklChats = [exports.yakklChat];
exports.yakklConnectedDomains = [exports.yakklConnectedDomain];
exports.yakklBlockedList = [exports.yakklBlocked];
exports.yakklWatchList = [exports.yakklWatch];
// Sample data...
...
exports.yakklStoredObjects = [
    { key: "preferences", value: exports.yakklPreferences },
    { key: "settings", value: exports.yakklSettings },
    { key: "yakklCurrentlySelected", value: exports.yakklCurrentlySelected },
    { key: "yakklSecurity", value: exports.yakklSecurity },
    { key: "yakklWalletBlockchains", value: exports.yakklWalletBlockchains },
    { key: "yakklWalletProviders", value: exports.yakklWalletProviders },
    { key: "profile", value: exports.profile },
    { key: "yakklBlockedList", value: exports.yakklBlockedList },
    { key: "yakklWatchList", value: exports.sampleWatch },
];
