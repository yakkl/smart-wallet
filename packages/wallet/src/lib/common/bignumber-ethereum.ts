...
//   // Instance methods
//   toWei(): BigNumber {
//     const etherValue = BigNumber.toBigInt(this._value) ?? BigInt(0);
//     return new BigNumber(etherValue * BigInt("1000000000000000000"));
//   }

//   toGwei(): BigNumber {
//     const etherValue = BigNumber.toBigInt(this._value) ?? BigInt(0);
//     return new BigNumber(etherValue * BigInt("1000000000"));
//   }
...
//   static from(value: BigNumberish): EthereumBigNumber {
//     if (typeof value === 'string' && /^0x[0-9a-fA-F]+$/.test(value)) {
//       console.log('>>>>>>>>>>>>>>>>>>>>>>>>>>from: value is hex:', value);
//       return new EthereumBigNumber(BigInt(value));
//     }
//     console.log('>>>>>>>>>>>>>>>>>>>>>>>>>>>>from: value is not hex: ', BigNumber.toBigInt(value));
//     const eth = new EthereumBigNumber(BigNumber.toBigInt(value));
//     console.log('>>>>>>>>>>>>>>>>>>>>>>>>>>>>from: eth: ', eth);
//     return eth; //new EthereumBigNumber(BigNumber.toBigInt(value));
//   }
...
//     const ethValue = BigNumber.from(value).toBigInt() ?? BigInt(0);
//     return new BigNumber(ethValue * BigInt("1000000000000000000"));
//   }

//   static toGwei(value: BigNumberish): BigNumber {
//     const ethValue = BigNumber.from(value).toBigInt() ?? BigInt(0);
//     return new BigNumber(ethValue * BigInt("1000000000"));
//   }
...
//   // Instance methods
//   toWei(): BigNumber {
//     return BigNumber.mul(this._value ?? BigInt(0), BigInt("1000000000000000000"));
//   }

//   toGwei(): BigNumber {
//     return BigNumber.mul(this._value ?? BigInt(0), BigInt("1000000000"));
//   }

//   toEther(): BigNumber {
//     return BigNumber.div(this._value ?? BigInt(0), BigInt("1000000000000000000"));
//   }
...
//   static toWei(value: BigNumberish): BigNumber {
//     const ethValue = BigNumber.from(value).toBigInt() ?? BigInt(0);
//     return BigNumber.mul(ethValue, BigInt("1000000000000000000"));
//   }

//   static toGwei(value: BigNumberish): BigNumber {
//     const ethValue = BigNumber.from(value).toBigInt() ?? BigInt(0);
//     return BigNumber.mul(ethValue, BigInt("1000000000"));
//   }

//   static toEther(value: BigNumberish): BigNumber {
//     const weiValue = BigNumber.from(value).toBigInt() ?? BigInt(0);
//     return BigNumber.div(weiValue, BigInt("1000000000000000000"));
//   }

//   static toFiat(value: BigNumberish, price: number): number {
//     const etherValue = EthereumBigNumber.toEther(value).toNumber();
//     if (etherValue === null) {
//       throw new Error("Invalid BigNumberish value");
//     }
//     return etherValue * price;
