<script lang="ts">
  ...
  export let message: YakklChat;
  export let by: 'human' | 'bot';
  export let i: number;
...
<div class="mb-4 flex items-start {by === 'human' ? 'flex-row-reverse' : 'flex-row'}">
  ...
  <div class="flex flex-col">
    ...
    {:else}
      ...
      />
    {/if}
    <button on:click={handleCopy} class="clip w-6 h-6 ml-1 mt-0.5 hover:text-gray-800"> 
    ...
    <div role="button" class="ml-1 mt-1 flex flex-col" on:click={handlePrint}>
