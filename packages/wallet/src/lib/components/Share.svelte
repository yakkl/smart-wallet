...
<Popover triggeredBy="#share" placement="bottom-start" class="w-[200px] text-sm font-normal text-gray-900 bg-white dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800 z-100">
  <div class="p-1 block">
    ...
    <div id="twitter" data-id="twitter" role="button" onclick={preventDefault(() => handleShare)} class="flex flex-row rounded-md ml-6 text-base font-semibold text-gray-900 dark:text-wwhite hover:bg-gray-200 ">
      <!-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="flex-col w-5 h-5 hover:fill-slate-600">
    ...
    <!-- svelte-ignore a11y_click_events_have_key_events -->
    <!-- svelte-ignore a11y_interactive_supports_focus -->
    <div id="linkedin" data-id="linkedin" role="button" onclick={preventDefault(() => handleShare)} class="my-1 flex flex-row rounded-md ml-6 text-base font-semibold text-gray-900 dark:text-white hover:bg-gray-200 ">
...
<!-- svelte-ignore a11y_click_events_have_key_events -->
<!-- svelte-ignore a11y_interactive_supports_focus -->
<div id="share" role="button" onclick={preventDefault(handleShare)} {...rest}> 
