<script lang="ts">
  ...
  import { PATH_ACCOUNTS, PATH_IMPORT_PHRASE, PATH_LOCK, PATH_SECURITY } from "$lib/common/constants";
  ...
  //   return browser_ext.tabs.getCurrent();
  // }
...
<ButtonGrid>
  ...
  <!-- <ButtonGridItem handle={handleComingSoon} title="Buy/Sell">
  ...
  <!-- <ButtonGridItem path={PATH_SETTINGS} title="Settings">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 mb-0">
