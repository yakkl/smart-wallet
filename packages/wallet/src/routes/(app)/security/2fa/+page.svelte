<script lang="ts">
  ...
  import { PATH_LOCK, PATH_LOGIN, PATH_REGISTER, PATH_SECURITY_2FA, PATH_SECURITY_PASSWORD, PATH_SECURITY_RESET, PATH_SECURITY_SECRET, PATH_SECURITY_USERNAME } from "$lib/common/constants";
  ...
  <main class="mt-1 mx-auto max-w-7xl px-4">
    ...
    <div class="grid grid-cols-2 gap-4 ">
        ...
        <div class="rounded-md shadow h-24">
          <!-- svelte-ignore a11y-click-events-have-key-events -->
          <!-- svelte-ignore a11y-interactive-supports-focus -->
          <div role="button" on:click={() => goto(PATH_SECURITY_2FA)}
            ...
            <span class="text-sm mt-2">2FA (MOST SECURE)</span>
          </div>
        </div>
