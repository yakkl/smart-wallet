  ...
  <main class="mt-1 mx-auto max-w-7xl px-4">
    ...
    <div class="grid grid-cols-2 gap-4 ">
        <div class="rounded-md shadow h-24">
          ...
          <div role="button" on:click={handleComingSoon} class="w-full h-full flex flex-col items-center justify-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
